...
class DocumentClassifierAgent(BaseAgent):
    ...
    def _get_classification_prompt(self) -> str:
        ...
        return """Ты - эксперт по классификации внутренних документов компании.
...
Отвечай только валидным JSON без дополнительных комментариев."""
    ...
    def _get_content_analysis_prompt(self) -> str:
        ...
        return """Проанализируй содержимое документа типа \"{document_type}\" и извлеки ключевую информацию.
...
Ответь в JSON формате:
{
  ...
  "document_structure_quality": 0.0-1.0,
